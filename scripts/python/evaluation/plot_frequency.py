...
from energydiff.utils.plot import plot_psd
...
def main():
    ...
    generated['real'] = data.denormalize_fn(target, *scaling_factor).squeeze(1) # [b, l]
    
    # reshape
    for k, v in generated.items():
        v = rearrange(v, 'b (l w) -> b l w', l=96)
        generated[k] = torch.fft.rfft(v, dim=2).abs().mean(dim=0) # [l w]
    
    # plot
    plot_psd(dict_psd={'Real Data': generated['real'], 'GMM': generated['gmm'], 'Ours': generated['ddpm']},
             save_dir='results/figures/psd/')
