...
from energydiff.utils.sample import ancestral_sample, ConditionCrafter
...
def main():
    ...
    sample_ddpm = ancestral_sample(config.sample.num_sample // trainer.accelerator.num_processes, val_batch_size, 
                         cond=cond,
